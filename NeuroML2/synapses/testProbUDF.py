#!/usr/bin/env python3
"""
Test the ProbUDF synapse

File: NeuroML2/synapses/testProbUDF.py
...
def main(simulation_id):
    ...
    # a new document
    newdoc = component_factory(neuroml.NeuroMLDocument, id="test_probUDF")  # type: neuroml.NeuroMLDocument
    ...
    simulation.include_lems_file("ProbUDF.synapse.xml",
...
def plots(data):
    ...
    generate_plot(xvalues=[data['t']] * len(yvalues2),
                  ...
                  labels=["g"], show_plot_already=False)
